...
const XPATHCONST = '//*[@id="appMountPoint"]/div/div/div[1]/div[2]/div/div[1]/div[1]/img[1]'

// Sometimes netflix animation doesn't play so the first if is not triggered.
function checkStillMovieImageExists() {
    return document.getElementsByClassName("previewModal--boxart");
}

var checkExist = setInterval(function () {
    if (checkStillMovieImageExists().length > 0) {
        var movieElements = checkStillMovieImageExists();
        var movieName = movieElements[0].alt;
